...
/////////////////////Define Reg Offset////////////////////////////////////////////////
#define SPAN 16
#define HPS_LED_CONTROL_OFFSET 0x0 //May need to be 32 bits
#define BASE_PERIOD_OFFSET 0x4 //ON THIS STEP
 ...
 * @miscdev: miscdev used to create a charecter device
...
static int led_patterns_probe(struct platform_device *pdev)
{
    ...
    // Init the misc device params  NEW!!!!!
    priv->miscdev.minor = MISC_DYNAMIC_MINOR;
    priv->miscdev.name = "led_patterns";  //!!!!!!!IS NAMING CORRECT?
...
static const struct of_device_id led_patterns_of_match[] = {
    { .compatible = "Guentherman,led-patterns", },
    { }
};
